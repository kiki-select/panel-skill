...
用法 A（raw_sql，最常用）:
  python create_panel.py \
      ...
      --title "AI-逐日登录账号数" --event-model raw_sql \
      --sql-file panel.sql \
...
def main() -> None:
    ...
    p.add_argument("--variables-file", type=str, default=None, help="可选，event_view.variables[] 的 JSON")
